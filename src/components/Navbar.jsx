...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed top-0 z-50 w-full backdrop-blur-md bg-base-100/30 shadow-sm border-b border-base-200/50 transition-all duration-300">
            ...
            <ul className="menu menu-horizontal gap-2">
              ...
              <Fade cascade damping={0.2} triggerOnce={true}>
                <li>
                  <NavLink
                    to="/"
                    className="btn-sm btn btn-ghost flex items-center gap-2"
                  >
                    <FaHome />
                    Home
                  </NavLink>
